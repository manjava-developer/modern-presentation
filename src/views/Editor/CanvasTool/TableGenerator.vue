<template>
  <div class="table-generator">
    <div class="title">
      <div class="left">Sheet {{endCell.length ? `${endCell[0]} x ${endCell[1]}` : ''}}</div>
    ...
    <div class="custom" v-else>
      ...
      <div class="row">
        <div class="label" style="width: 25%;">Column</div>
        <NumberInput
          :min="1"
          :max="20"
...
const insertCustomTable = () => {
  if (customRow.value < 1 || customRow.value > 20) return message.warning('The number of rows must be between 0 and 20!')
  if (customCol.value < 1 || customCol.value > 20) return message.warning('The number of columns must be between 0 and 20!')
