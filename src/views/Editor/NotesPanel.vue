  ...
  >
    <div class="container">
      <div class="notes" ref="notesRef">
        ...
        <div class="empty" v-if="!notes.length">No notes on this slide</div>
      </div>
      <div class="send">
        <TextArea 
          ref="textAreaRef"
        ...
        />
        <div class="footer">
          <IconDelete class="btn icon" v-tooltip="'Clear all notes on this slide'" style="flex: 1" @click="clear()" />
