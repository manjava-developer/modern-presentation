  ...
  return [
    ...
    { divider: true },
    {
      ...
      children: [
        ...
        { text: 'Align Horizontally', handler: () => alignElementToCanvas(ElementAlignCommands.HORIZONTAL) },
    ...
    },
    {
      ...
      children: [
        { text: 'Align Center', handler: () => alignElementToCanvas(ElementAlignCommands.CENTER) },
        { text: 'Align Vertically', handler: () => alignElementToCanvas(ElementAlignCommands.VERTICAL) },
    ...
    { divider: true },
    {
      ...
      children: [
        ...
        { text: 'Move Up One Layer', handler: () => orderElement(props.elementInfo, ElementOrderCommands.UP) },
      ],
    },
    {
      text: 'Send to Back',
      ...
      children: [
        ...
        { text: 'Move Down One Layer', handler: () => orderElement(props.elementInfo, ElementOrderCommands.DOWN) },
      ],
    },
    { divider: true },
    {
