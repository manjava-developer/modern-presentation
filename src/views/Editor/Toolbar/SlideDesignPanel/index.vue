<template>
  <div class="slide-design-panel">
    ...
    <div class="row">
      <div style="width: 40%;">Background</div>
      <Popover trigger="click" style="width: 60%;">
        <template #content>
          <ColorPicker
    ...
    <div class="row">
      <Button style="flex: 1;" @click="applyThemeToAllSlides(moreThemeConfigsVisible)"><IconCheck style="margin-right: 5px;"/> Apply Theme to All</Button>
    </div>

    <div class="row">
      <Button style="flex: 1;" @click="themeStylesExtractVisible = true"><IconPlatte style="margin-right: 5px;" /> <i class="i-icon i-icon-platte"></i> Extract Theme from Slide</Button>
    </div>
