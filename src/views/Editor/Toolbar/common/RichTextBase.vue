<template>
  <div class="rich-text-base">
    ...
    <ButtonGroup class="row" passive>
      <Popover trigger="click" v-model:value="AIPopoverVisible" style="width: 25%;">
        <template #content>
          ...
          <PopoverMenuItem center @click="execAI('Expand Content')">Expand</PopoverMenuItem>
          <PopoverMenuItem center @click="execAI('Summarize')">Summarize</PopoverMenuItem>
        </template>
        <CheckboxButton
          first
          style="width: 100%;"
          v-tooltip="'AI Assistance'"
    ...
    >
      ...
      <RadioButton value="center" v-tooltip="'Align Center'" style="flex: 1;"><IconAlignTextCenter /></RadioButton>
